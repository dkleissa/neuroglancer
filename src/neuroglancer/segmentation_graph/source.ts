...
import { Disposer, RefCounted, Owned} from 'neuroglancer/util/disposable';
...
export abstract class SegmentationGraphSourceConnection extends RefCounted {
  constructor(public graph: SegmentationGraphSource, public segmentsState: VisibleSegmentsState) {
    super();
  }
  abstract computeSplit(include: Uint64, exclude: Uint64):
      {include: Uint64[], exclude: Uint64[]}|undefined;
}

export function  trackWatchableValueSegment(graph: SegmentationGraphSource,
